...
export const taxModels: TaxModelDefinition[] = [
  {
    ...
    advantages: [
      ...
      "Control total de conciliacion, reportes y Comisión OficiosPro.",
    ],
    disadvantages: [
...
export const accountantValidationPoints = [
  ...
  "Materiales y repuestos: documentacion de respaldo, comisión sobre materiales si aplica y si requieren factura del proveedor a OP SpA o al especialista.",
