...
export const pricingModeLabels: Record<PricingMode, string> = {
  ...
  visit_then_quote: "Visita técnica + cotización",
...
export const pricingModeOptions: { value: PricingMode; label: string; helper: string }[] = [
  { value: "fixed", label: "Precio fijo", helper: "El cliente ve créditos exactos antes de reservar." },
  { value: "hourly", label: "Por hora", helper: "El cliente confirma horas iniciales o solicita evaluacion." },
  { value: "quote_required", label: "Requiere cotización", helper: "Se crea solicitud y propuesta antes del pago final." },
  { value: "visit_then_quote", label: "Visita + cotización", helper: "Se cobra diagnostico y luego se envia propuesta." },
...
export const defaultQuoteAgreements: QuoteAgreement[] = [
  {
    ...
    history: ["El cliente solicito cotización con fotos y descripcion del alcance."],
  ...
  },
  {
    ...
    platformNote: "Comisión revisada y propuesta aprobada.",
    history: [
      "El especialista envio una propuesta.",
      "OficiosPro reviso comisión y condiciones.",
      "Propuesta aceptada. Se retendran los créditos.",
    ],
  ...
  },
  {
    ...
    serviceName: "Técnico riego agricola",
    commune: "Talca",
    status: "specialist_reviewing",
    originalRequest: "Diagnostico de baja presion en sector de riego tecnificado.",
    proposal: {
      description: "Visita técnica para diagnostico y levantamiento de propuesta.",
      laborCredits: 0,
      materialCredits: 0,
      visitCredits: 20,
      totalCredits: 20,
    ...
    history: ["OficiosPro asigno revision técnica antes de cotizar el trabajo completo."],
...
export const defaultAdditionalRequests: AdditionalRequest[] = [
  {
    ...
    comment: "El cobro adicional requiere aprobacion del cliente antes de descontar créditos.",
...
export const defaultFlexibleServices: FlexibleService[] = [
  ...
  },
  {
    ...
    name: "Técnico riego agricola",
    description: "Diagnostico inicial en terreno y cotización posterior.",
