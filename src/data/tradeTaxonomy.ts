...
const seeds: CategorySeed[] = [
  ...
  },
  {
    ...
    seoEnabled: true,
    notes: "Gas y calefont deben indicar certificacion cuando aplica.",
  ...
  },
  {
    ...
    seoEnabled: true,
    notes: "Separar hogar vs comercial en cotizacion y cobertura.",
    specialtyDefaults: { requiresCertification: true, riskLevel: "high", pricingModeDefault: "visit_then_quote" },
    specialties: [
  ...
  },
  {
    ...
    description: "Jardines, riego, piscinas, limpieza tecnica y servicios exteriores.",
  ...
  },
  {
    ...
    seoEnabled: false,
    notes: "Mantener en formacion hasta definir cotizacion, medicion y expectativas de materiales.",
  ...
  },
  {
    ...
    relatedProblems: ["porton detenido", "estructura dañada", "proteccion faltante"],
    seoEnabled: false,
  ...
  },
  {
    ...
    description: "Edificios y condominios: salas tecnicas, portones, camaras, citofonia y espacios comunes.",
    segment: "comunidades",
    clientVisibility: "pilot",
    registrationVisibility: "active",
    coverageStatus: "limited",
  ...
  },
  {
    ...
    seoEnabled: false,
    notes: "Piloto para demanda empresa; separar oficios tecnicos de roles operativos no publicados.",
    specialtyDefaults: { clientVisibility: "forming", coverageStatus: "forming", pricingModeDefault: "visit_then_quote" },
    specialties: [
      ...
      { slug: "tecnicos-electricos", label: "Tecnicos electricos", clientVisibility: "pilot", coverageStatus: "limited", requiresCertification: true },
      { slug: "tecnicos-climatizacion", label: "Tecnicos de climatizacion", clientVisibility: "pilot", coverageStatus: "limited", requiresCertification: true },
  ...
  },
  {
    ...
    description: "Riego tecnificado, maquinaria agricola, packing, frio, bombas y operacion de campo.",
    segment: "industria_campo",
    clientVisibility: "pilot",
    registrationVisibility: "active",
    coverageStatus: "limited",
  ...
  },
  {
    ...
    description: "Camaras, alarmas, control de acceso, redes y soporte tecnico.",
    segment: "hogar",
    clientVisibility: "pilot",
    registrationVisibility: "active",
    coverageStatus: "limited",
    ...
    seoEnabled: false,
    notes: "Piloto tecnico; distinguir instalaciones simples de seguridad electronica critica.",
    specialties: [
