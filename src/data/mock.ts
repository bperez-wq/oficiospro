...
const baseSpecialists: Specialist[] = [
  {
    ...
    image: "/assets/oficios/perfiles/victor-mendoza.jpg",
  ...
  },
  {
    ...
    image: "/assets/oficios/perfiles/carolina-poblete.jpg",
  ...
  },
  {
    ...
    image: "/assets/oficios/perfiles/francisco-soto.jpg",
  ...
  },
  {
    ...
    image: "/assets/oficios/perfiles/daniela-ponce.jpg",
  ...
  },
  {
    ...
    image: "/assets/oficios/perfiles/felipe-rojas.jpg",
  ...
  },
  {
    ...
    image: "/assets/oficios/perfiles/patricio-herrera.jpg",
  ...
  },
  {
    ...
    image: "/assets/oficios/perfiles/sofia-vergara.jpg",
  ...
  },
  {
    ...
    image: "/assets/oficios/perfiles/andres-ibarra.jpg",
  ...
  },
  {
    ...
    image: "/assets/oficios/perfiles/nicolas-bravo.jpg",
  ...
  },
  {
    ...
    image: "/assets/oficios/perfiles/rodrigo-palma.jpg",
  ...
  },
  {
    ...
    /* Retrato con credencial "Elena Morales" (match probable, confirmado por nombre en foto). */
    image: "/assets/oficios/perfiles/elena-morales.jpg",
...
const generatedStableIdsByName: Record<string, string> = {
  "Alberto Campos": "claudio-riquelme",
  "Alejandro Soto": "renato-bravo",
  "Andrés Flores": "matias-fuentes",
  ...
  "Fernando Diaz": "pablo-carrillo",
  "Gabriel Pérez": "juan-moya",
  "Hugo Ramírez": "sergio-tapia",
  "Javier Morales": "fabian-orellana",
  "Leonardo Herrera": "ivan-parra",
  "Manuel Vargas": "leonardo-jara",
  "Marcelo Soto": "manuel-godoy",
  "Mauricio López": "ricardo-fuenzalida",
  "Oscar Mendoza": "angelo-paredes",
  "Pablo Morales": "hugo-sandoval",
  "Raúl Contreras": "vicente-espinoza",
  "Renato Prado": "juan-pablo-vera",
  "Ricardo Fuentes": "marcelo-henriquez",
  "Rodrigo Vargas": "ruben-zamora",
  "Sergio Ramirez": "enrique-meneses",
};
...
const generatedSpecialists: Specialist[] = generatedNames.map((name, index) => {
  ...
  const profileSlug = slugFromName(name);
  const stableId = generatedStableIdsByName[name] ?? profileSlug;
