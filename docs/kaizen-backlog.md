...
| KZ-011 | Input semanal de salud del modelo no tiene collector agregado persistente y seguro | Reporte business-health 2026-06-22 / KZ-010 | alto | alta | analytics | Codex | validando | Add safe business health input collector | validate/build/report/dry-run | pendiente |
