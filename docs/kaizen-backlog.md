...
| KZ-037 | Densidad de red baja por comuna/oficio puede generar busquedas sin match y abandono | Benjamin / auditoria critica 2026-06-27 | muy alto | alta | growth | ChatGPT + Codex + Claude | observado | - | medir busquedas sin match, leads por comuna y especialistas por oficio | pendiente |
| KZ-038 | Perfiles publicos no deben depender de una experiencia tipo "Cargando perfil..." ni fallbacks pobres | Benjamin / auditoria critica 2026-06-27 | alto | alta | seo | Codex | observado | - | revisar HTML inicial, fallback y tiempo de carga de perfiles | pendiente |
| KZ-039 | Funnel post-busqueda no explica con suficiente claridad que ocurre despues de cotizar, reservar o solicitar visita | Benjamin / auditoria critica 2026-06-27 | alto | alta | conversion | Claude + Codex | observado | - | revisar CTAs, CRM event, mensaje de confirmacion y siguiente paso | pendiente |
| KZ-040 | Onboarding especialista sigue dependiendo de revision humana y puede saturarse si aumenta el volumen | Benjamin / auditoria critica 2026-06-27 | alto | media-alta | operacion | Codex + Claude | observado | - | revisar captura temprana, cola de revision, SLA interno y automatizacion segura | pendiente |
| KZ-041 | Sistema de creditos requiere explicacion publica mas clara sobre valor, compra, recarga, reembolsos, disputas, Club Hogar y empresas | Benjamin / auditoria critica 2026-06-27 | alto | media | conversion | Claude + ChatGPT | observado | - | revisar copy de bolsa, checkout, planes, FAQ y modales de creditos | pendiente |
