...
| KZ-037 | Densidad de red baja por comuna/oficio puede generar busquedas sin match y abandono | Benjamin / auditoria critica 2026-06-27 | muy alto | alta | growth | ChatGPT + Codex + Claude | en_progreso | Improve critical marketplace UX and conversion clarity (Claude) | validate/build/dry-run | UX: banner de baja densidad (1-3 resultados) con captura de demanda en /especialistas; medicion de captacion por comuna/oficio sigue pendiente para Codex |
| KZ-038 | Perfiles publicos no deben depender de una experiencia tipo "Cargando perfil..." ni fallbacks pobres | Benjamin / auditoria critica 2026-06-27 | alto | alta | seo | Codex | en_progreso | Improve critical marketplace UX and conversion clarity (Claude) | validate/build/dry-run | UX: skeleton de carga + not-found con captura de demanda. Ruta /especialistas/[id] ya es SSG con initialSpecialist. Pendiente Codex: HTML inicial para ruta /especialistas/perfil (query) |
| KZ-039 | Funnel post-busqueda no explica con suficiente claridad que ocurre despues de cotizar, reservar o solicitar visita | Benjamin / auditoria critica 2026-06-27 | alto | alta | conversion | Claude + Codex | en_progreso | Improve critical marketplace UX and conversion clarity (Claude) | validate/build/dry-run | UX: SuccessState del modal con bloque "Que pasa ahora" (3 pasos honestos, sin SLA falso). Pendiente: evidencia CRM por paso |
| KZ-040 | Onboarding especialista sigue dependiendo de revision humana y puede saturarse si aumenta el volumen | Benjamin / auditoria critica 2026-06-27 | alto | media-alta | operacion | Codex + Claude | en_progreso | Improve critical marketplace UX and conversion clarity (Claude) | validate/build/dry-run | UX: pasos con detalle, reassurance de revision humana, captura temprana y documentos despues en /registro-especialista. Pendiente Codex: cola de revision y automatizacion |
| KZ-041 | Sistema de creditos requiere explicacion publica mas clara sobre valor, compra, recarga, reembolsos, disputas, Club Hogar y empresas | Benjamin / auditoria critica 2026-06-27 | alto | media | conversion | Claude + ChatGPT | en_progreso | Improve critical marketplace UX and conversion clarity (Claude) | validate/build/dry-run | UX: FAQ con seccion completa + footer y link en CreditExplainer (Home/Bolsa/Checkout/Club/Empresas). Modelo corregido por Benjamin: tope de acumulacion 10 meses (no vencimiento 24m); accumulatesMonths 24->10 en copy/dato. PENDIENTE Codex+Benjamin: implementar lifecycle real (tope = monthlyCredits x 10, excedente -> plataforma) en finanzas; hoy backend aun usa creditExpirationMonths=24. Sin cambiar precios ni comision |
| KZ-042 | Admin clasico mostraba KPIs/fallback local aunque D1 remoto ya tenia leads y postulaciones reales | Benjamin / ciclo backoffice pipeline 2026-07-01 | alto | alta | crm | Codex | listo_para_deploy | Connect admin dashboard to live D1 backoffice data + merge origin/main | validate/build/dry-run/ops:backoffice-pipeline | Diagnostico H3: captura y D1 existen, dashboard clasico leia localStorage. Rama sincronizada con origin/main y /admin mantiene capa viva desde /api/admin/leads y /api/admin/crm/overview con fallback local explicito |
| KZ-043 | Traspaso de liderazgo Kaizen desde Codex hacia Claude debe quedar documentado y operativo | Benjamin / continuidad IA 2026-07-05 | alto | alta | operacion | Claude + Benjamin | listo_para_deploy | pendiente | docs-only | Handoff maestro creado para que Claude lidere desde 2026-07-06 y Codex quede como apoyo tecnico puntual |
| KZ-044 | Exito de postulacion expulsaba al especialista al Home a los 2,5 s, antes de poder leer la tarjeta de exito o usar el CTA de referidos; quick lead sin continuidad al Pasaporte | Claude / auditoria funnel SEC 2026-07-05 | alto | alta | conversion | Claude | validando | Improve specialist registration success UX and SEC funnel continuity | tsc + validate OK; test:unit/build/dry-run pendientes en Windows | Success card protagonista sin redirect, quick lead con CTA de continuidad que preserva atribucion sec_mailing, refuerzo SEC en origen de invitacion |
