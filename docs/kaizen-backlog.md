...
| KZ-041 | Sistema de creditos requiere explicacion publica mas clara sobre valor, compra, recarga, reembolsos, disputas, Club Hogar y empresas | Benjamin / auditoria critica 2026-06-27 | alto | media | conversion | Claude + ChatGPT | en_progreso | Improve critical marketplace UX and conversion clarity (Claude) | validate/build/dry-run | UX: FAQ con seccion completa de creditos + footer y link a FAQ en CreditExplainer (Home/Bolsa/Checkout/Club/Empresas). Sin cambiar precios ni comision |
