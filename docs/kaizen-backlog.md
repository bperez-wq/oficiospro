...
| KZ-042 | Admin clasico mostraba KPIs/fallback local aunque D1 remoto ya tenia leads y postulaciones reales | Benjamin / ciclo backoffice pipeline 2026-07-01 | alto | alta | crm | Codex | validando | pendiente | validate/build/dry-run/ops:backoffice-pipeline | Diagnostico H3: captura y D1 existen, dashboard clasico leia localStorage. /admin ahora carga capa viva desde /api/admin/leads y /api/admin/crm/overview con fallback local explicito |
