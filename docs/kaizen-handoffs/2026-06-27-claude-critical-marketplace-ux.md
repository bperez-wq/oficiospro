...
- `src/app/faq/page.tsx`: nueva sección completa de créditos (qué es 1 crédito, cómo se compran, cómo se
  usan, qué pasa si no se completa el trabajo, reembolsos/disputas, vencimiento 24m, Club Hogar, empresas).
...
- Si se confirma públicamente la vigencia de créditos a 24 meses y la política de reembolsos/disputas tal
  como quedó redactada en FAQ (copy honesto pero conviene validación operativa/legal).
